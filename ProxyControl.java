    	...
    	if (sampler != null) {
			if (filterContentType(result) && filterUrl(sampler)) {
				...
				if (logSessionDir.equals("") ){
	      		...
	      		try {
	     			FileWriter fileWriter = new FileWriter(logSessionDir + File.separator + "request_" + logFilePrefix++ + ".txt");
	     			WriterTarget logTarget = new WriterTarget(fileWriter, new RawFormatter());
